...
- 2026-08-14: FINAL WEBSITE REFINEMENT — (1) Home & Contact removed from primary nav (logo → homepage; Talk to an Expert remains CTA). (2) All dropdowns verified pixel-identical (302px, 16px radius, same padding/shadow/animation, left-aligned). (3) Product pages confirmed video-free; Homepage video untouched. (4) Insights menu = Articles / Case Studies / Resources — new /insights/resources page (6 resource-type cards, request-access pattern; /insights/blog retained but unlinked). (5) Team Augmentation single page extended: 7 delivery/hiring models (Onsite, Offshore, Hybrid, Contract Staffing, Contract-to-Hire, Permanent Hiring, Project Teams) + coverage PAN India / Middle East (Dubai, UAE) / Europe / APAC / International. (6) Industry set completed: NEW /industries/pharmaceutical and /industries/textile-apparel; Industries dropdown now lists the 9 verified industries. (7) Footer rebuilt: 5 columns (Services, Products, Industries, Insights, Company) + LinkedIn/YouTube socials + contact + legal.
